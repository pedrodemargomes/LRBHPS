		...
		struct vm_userfaultfd_ctx *uf, struct list_head *uf_unmap)
{
	...
	// pr_info("thp_reservations_mremap");
	thp_reservations_mremap(mm, vma, old_addr, new_vma, new_addr, old_len,
				need_rmap_locks);
	...
	if (unlikely(err)) {
		 ...
		 */
		thp_reservations_mremap(mm, new_vma, new_addr, vma, old_addr,
					moved_len, true);
